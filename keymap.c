...
,CTL_ESC,      KC_LGUI,   KC_LALT,   KC_UP,     KC_DOWN   ,KC_PGDN,  KC_PGUP                     ,KC_MPLY,       KC_MPRV,  KC_LEFT,  KC_RGHT,   KC_EQL,  KC_QUES,     KC_PEQL

                                                    ,KC_SPC, KC_ENT, KC_LSFT                    ,KC_MNXT, KC_DEL, KC_BSPC
)
};
